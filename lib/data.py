...
#
def get_kobest_hellaswag(nsamples, seed, seqlen, tokenizer):

    # Load train datasets
    traindata = load_dataset("skt/kobest_v1", "hellaswag")["train"]
...
def get_loaders(name, nsamples=128, seed=0, seqlen=2048, tokenizer=None):
    ...
    if "kobest_hellaswag" in name:
        return get_kobest_hellaswag(nsamples, seed, seqlen, tokenizer)